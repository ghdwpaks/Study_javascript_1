...
function checkclick3() {
    if(title.style.color != "yellowgreen") {
...
title.addEventListener("mouseenter", checkclick3);
//click = 클릭하면 이벤트 인지함
//mouseenter = 마우스를 호버링하면 인지함
function handleoffline() {console.log("offline to server")}
function handleonline() {console.log("online to server")}
